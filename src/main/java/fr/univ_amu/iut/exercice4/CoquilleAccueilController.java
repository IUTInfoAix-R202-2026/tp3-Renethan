...
public class CoquilleAccueilController {
  ...
  private void onMesSites() {
    ...
    // afficher le titre "Mes sites de suivi" au centre,
  ...
  private void onImporter() {
    ...
    // titre "Importer une nuit", statut "Rubrique active : Importer une nuit".
  }
  ...
  private void onVueTabulaire() {
    ...
    // titre "Vue tabulaire des passages", statut "Rubrique active : Vue
    // tabulaire".
  }
  ...
  private void onParametres() {
    ...
    // titre "Paramètres de l'application", statut "Rubrique active : Paramètres".
  }
